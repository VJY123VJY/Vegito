...
export type ApiProduct = { id: number; name: string; unit: string; description?: string | null; min_price?: number | string | null; is_in_stock: boolean; images: { image_url: string; is_primary: boolean }[]; seller_products: { seller_business_name?: string | null; seller_product_id?: number }[] };
